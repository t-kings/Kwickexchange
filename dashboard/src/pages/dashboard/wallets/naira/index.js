...
import amount from "../images/email.png";
            ...
            {formTab === 1 ? (
                  ...
                  <div className={walletStyle.holdAccounts}>
                    ...
                    <div className={walletStyle.withDrawAccountsList}>
                      <p className={walletStyle.verify}>
                        Your amount and Phone number are not verified. Veirfy
                        Now
                      </p>
                      <button className={walletStyle.choose}>
              ...
              <div className={walletStyle.transactions}>
                ...
                <div className={walletStyle.transactions_list}>
                  ...
                  <div className={walletStyle.accounts_list}>
                    <div>
                      ...
                      <div className={walletStyle.second}>
                        <button className={walletStyle.red}>Delete</button>
                        <button>Edit</button>
                      </div>
                    </div>
                  </div>
              ...
              <div className={walletStyle.send}>
                ...
                <div className={walletStyle.actions}>
                  ...
                  <div className={walletStyle.action}>
                    ...
                    <p>Send to users on this platform via amount</p>
                    <button className={walletStyle.link_btn_gold}>
                      <span>amount</span>
                      <svg
                        width="13"
